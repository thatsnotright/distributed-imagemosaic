 ...
 *
 *
 * This class filters out everything but bitmaps (*.BMP).
 ************************************************/
...
public class myBMPFilter extends FileFilter {
    ...
    public boolean accept(File f) {
        ...
        if (extn != null) {
            if (extn.equals("BMP") ||  // These are okay.
                extn.equals("bmp")) {
                    return true;
            } else {
                    return false;
    ...
    public String getDescription() {
        return "BMP Images";  // The description of the file type.
    }
}