...
public class compareRender extends renderTaskPlugin {
    ...
    public compareRender (Color[][] ma, IImageList tileLib, RenderedImage baseImg, int h, int v, int pw, int ph) {
...
//************************************************************
    ...
    private IImageList shortenList(Color c) {
        int redDiff, blueDiff, greenDiff;
        IImageList outList = new imageList();
    ...
    private int findBestFit(Raster r, int[][] tileArray, int x, int y, Color c) {
        ...
        IImageList theList = shortenList(c);
